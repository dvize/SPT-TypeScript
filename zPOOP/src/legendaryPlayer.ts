  ...
  static CreateProgressFile(
    ...
    let progressFile: progressRecord = {
      ...
      ScoreData: {
        ...
        LongestKillShot: data.Stats.OverallCounters.Items.find(
          (x) => x.Key["LongestKillShot"]
        ).Value,
        OverallDeaths: data.Stats.OverallCounters.Items.find(
          (x) => x.Key["Deaths"]
        ).Value,
        OverallKills: data.Stats.OverallCounters.Items.find(
          (x) => x.Key["Kills"]
        ).Value,
        OverallPedometer: data.Stats.OverallCounters.Items.find(
          (x) => x.Key["Pedometer"]
        ).Value,
      },
    };
